...
class TrainingLogger():
    def __init__(
        ...
        self._save_only_best: bool = self.conf.logging.save_only_best

        self.loggers = []
        if self.use_imagesaver:
            self.loggers.append(ImageSaver(model=model, result_dir=self._result_dir, save_only_best=self._save_only_best))
