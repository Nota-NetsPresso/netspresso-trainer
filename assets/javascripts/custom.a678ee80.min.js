...
(() => {
  ...
  var et = (e, r, t) =>
    ...
    Ke = (e, r) => {
      ...
      if (Zr) for (var t of Zr(r)) Ln.call(r, t) && et(e, t, r[t]);
      return e;
    };
  var Oe = (e, r) => () => (
  ...
  var Ne = Oe((J) => {
    (function () {
      ...
      (R = 150),
        ...
        (S = 150),
        (u = 0.75),
        (J.score = function (d, x, E) {
          var O, y, g, T;
          return (
            (y = E.preparedQuery),
            (O = E.allowErrors),
            O || o(d, y.core_lw, y.core_up)
              ? ((T = d.toLowerCase()), (g = r(d, T, y)), Math.ceil(g))
              : 0
          );
        }),
        (J.isMatch = o =
          function (d, x, E) {
            ...
            for (O = -1, y = -1; ++y < T; ) {
              for (
                F = x.charCodeAt(y), z = E.charCodeAt(y);
                ++O < g && ((I = d.charCodeAt(O)), !(I === F || I === z));
        ...
        (J.computeScore = r =
          function (d, x, E) {
            ...
            if (
              ...
              return v(q, $, y, O.pos);
            if (((se = x.indexOf(oe)), se > -1))
              return h(d, x, me, oe, se, q, $);
            for (
              _e = new Array(q),
                F = new Array(q),
                Cr = w(q, $),
        ...
        (J.scoreConsecutives = l =
          function (d, x, E, O, y, g, T) {
            var F, z, I, H, C, $, V;
            for (
              z = d.length,
                H = E.length,
              ...
              E[g] === d[y] && $++;
            return (
              V < F && y--, V === 1 ? 1 + 2 * $ : m(V, H, $, T, a(y, d, x, z))
            );
          }),
        (J.scoreExactMatch = h =
          function (d, x, E, O, y, g, T) {
        ...
        (n = function (d, x, E, O) {
          ...
          for (g = -1; ++g < T; ) if (c(g, d, x) && ++y > O) return !1;
          return !0;
        });
    }).call(J);
  });
  var _r = Oe((De) => {
    (function () {
      ...
      (s = Ne()),
        ...
        (u = 20),
        (t = 2.5),
        (De.score = function (f, p, l) {
          var v, h, m, b;
          return (
            (h = l.preparedQuery),
            (v = l.allowErrors),
            v || i(f, h.core_lw, h.core_up)
              ? ((b = f.toLowerCase()),
                (m = e(f, b, h)),
                (m = a(f, b, m, l)),
                Math.ceil(m))
        ...
        (a = function (f, p, l, v) {
          ...
          return (
            (m =
              b === -1
                ? l
                : R * e(f.slice(b + 1, S + 1), p.slice(b + 1, S + 1), E)),
            (h = (0.5 * u) / (u + r(f, S + 1, x))),
            h * m + (1 - h) * l * c(0, t * d)
          );
        }),
        ...
        (o = function (f, p, l, v, h) {
          ...
          return b === 0 && h > 0 ? 0.9 * o(f, p, l, S - 2, h - 1) : b / m;
        });
    }).call(De);
  });
  var Jr = Oe((cn, pn) => {
    (function () {
      ...
      (c = _r()),
        ...
        (a = function (u) {
          var s, f, p, l;
          for (f = "", p = 0, l = u.length; p < l; p++)
            (s = u[p]), (f += s.toUpperCase()[0]);
          return f;
        }),
        (n = function (u) {
          var s, f, p;
        ...
        (mn.exports = function (i, a, c) {
          ...
          for (
            ...
            !(
              !!w &&
              ((v = h.score(w, a, c)),
              v > 0 && (m.push({ candidate: s, score: v }), !--b))
            ));
            R++
          );
      ...
      (s = Ne()),
        ...
        (Or.match = o =
          function (f, p, l) {
            ...
            return (
              ...
              (w = l.preparedQuery),
              (b = l.pathSeparator),
              v || t(f, w.core_lw, w.core_up)
                ? ((S = f.toLowerCase()),
                  (m = r(f, S, w)),
                  m.length === 0 ||
                    (f.indexOf(b) > -1 && ((h = e(f, S, w, b)), (m = i(m, h)))),
                  m)
                : []
            );
          }),
        (Or.wrap = function (f, p, l) {
          ...
          for (b = "", v = -1, w = 0; ++v < m.length; ) {
            for (
              h = m[v], h > w && ((b += f.substring(w, h)), (w = h));
              ++v < m.length;
            ...
            h++,
              h > w && ((b += d), (b += f.substring(w, h)), (b += R), (w = h));
          }
        ...
        (r = function (f, p, l, v) {
          ...
          for (
            ...
            (q[g] = 0), (E[g] = 0);
          for (y = -1; ++y < T; )
            for (V = 0, se = 0, x = 0, me = p[y], g = -1; ++g < I; )
              (O = 0),
                (R = 0),
                (ne = se),
                $[g] === me &&
                  ((oe = n(y, f, p)),
                  (O = x > 0 ? x : u(f, p, C, $, y, g, oe)),
                  (R = ne + c(y, g, oe, S, O))),
                (se = q[g]),
                (x = E[g]),
                V > se ? (z = m) : ((V = se), (z = w)),
      ...
      (t = hn()),
        ...
        (bn.exports = {
          filter: function (u, s, f) {
            return (
              f == null && (f = {}),
              s != null && s.length && u != null && u.length
                ? ((f = o(f, s)), t(u, s, f))
                : []
            );
          },
          score: function (u, s, f) {
            return (
              f == null && (f = {}),
              u != null && u.length && s != null && s.length
                ? ((f = o(f, s)),
                  f.usePathScoring ? i.score(u, s, f) : c.score(u, s, f))
                : 0
            );
          },
        ...
        (o = function (u, s) {
          return (
            ...
            u.preparedQuery == null &&
              (u.preparedQuery = a && a.query === s ? a : (a = new e(s, u))),
            u
          );
        });
    }).call(vn);
  ...
  function ot(e, r, t) {
    ...
    function u(l) {
      l.value instanceof ve
        ? Promise.resolve(l.value.v).then(s, f)
        : p(i[0][2], l);
    }
    function s(l) {
      c("next", l);
...
` +
  ...
  var We = (function (e) {
    ...
    function r(t) {
      ...
      return (
        (n.isStopped = !1),
        t ? ((n.destination = t), Be(t) && t.add(n)) : (n.destination = Hn),
        n
      );
    }
    return (
  ...
  var Hn = { closed: !0, next: ce, error: kn, complete: ce };
  var Me = (function () {
      ...
      (r.prototype.next = function (t) {
        ...
        Ae(function () {
          ...
          if ((n._throwIfClosed(), !n.isStopped)) {
            ...
            try {
              for (
                var a = G(n.currentObservers), c = a.next();
                !c.done;
                c = a.next()
              ) {
                var u = c.value;
    ...
    return (
      ...
      (r.prototype._trimBuffer = function () {
        ...
        if ((n < 1 / 0 && c < i.length && i.splice(0, i.length - c), !a)) {
          for (var u = o.now(), s = 0, f = 1; f < i.length && i[f] <= u; f += 2)
            s = f;
          s && i.splice(0, s + 1);
        }
      }),
      ...
      (r.prototype.recycleAsyncId = function (t, n, o) {
        ...
        n != null &&
          ((i = a[a.length - 1]) === null || i === void 0 ? void 0 : i.id) !==
            n &&
          (Ce.cancelAnimationFrame(n), (t._scheduled = void 0));
      }),
      r
    );
  })(er);
  ...
  function ir(e) {
    return (
      Symbol.asyncIterator && _(e == null ? void 0 : e[Symbol.asyncIterator])
    );
  }
  function ar(e) {
      ...
      return Ge(this, function (u) {
        switch (u.label) {
          ...
          case 4:
            return [3, 11];
          case 5:
            return (c = u.sent()), (o = { error: c }), [3, 11];
          case 6:
            return (
              u.trys.push([6, , 9, 10]),
  ...
  function Ct(e) {
    if (e.length === 1) {
      var r = e[0];
      if (Jn(r)) return { args: r, keys: null };
      if (eo(r)) {
        var t = Zn(r);
        return {
  ...
  function Pe(e, r, t) {
    var n = _(e) || r || t ? { next: e, error: r, complete: t } : e;
    return n
      ? A(function (o, i) {
          var a;
          ...
          o.subscribe(
            M(
              ...
              function (u) {
                var s;
                (s = n.next) === null || s === void 0 || s.call(n, u),
                  i.next(u);
              },
              function () {
                var u;
              ...
              function (u) {
                var s;
                (c = !1),
                  (s = n.error) === null || s === void 0 || s.call(n, u),
                  i.error(u);
              },
              function () {
                var u, s;
  ...
  function Nt(e) {
    return N(K(document.body, "focusin"), K(document.body, "focusout")).pipe(
      $r(1),
      k(() => {
        let r = yr();
  ...
  function Qt(e) {
    return N(K(e, "scroll"), K(window, "resize")).pipe(
      Vr(0, Wr),
      k(() => Dt(e)),
      he(Dt(e))
    );
    ...
    bo = (function () {
      function e() {
        (this.connected_ = !1),
          ...
          (this.refresh = lo(this.refresh.bind(this), mo));
      }
      return (
  ...
  function go(e) {
    ...
    if (
      (n.boxSizing === "border-box" &&
        (Math.round(c + i) !== r && (c -= Kt(n, "left", "right") + i),
        Math.round(u + a) !== t && (u -= Kt(n, "top", "bottom") + a)),
      !Eo(e))
    ) {
  ...
  var Oo = (function () {
    ...
    To = (function () {
      function e(r, t) {
        var n = _o(t);
        Yt(this, { target: r, contentRect: n });
      }
      return e;
    })(),
    Ao = (function () {
  ...
  var Co = new B(),
    Yp = je(() =>
      ...
      D((e) => N($e, Z(e)).pipe(Ee(() => e.disconnect()))),
      Se(1)
    );
  function en(e) {
  ...
  function on(e, r) {
    ...
    else if (Array.isArray(r)) for (let t of r) on(e, t);
  }
  function re(e, r, ...t) {
  ...
  function Lo(e, r = { credentials: "same-origin" }) {
    return X(fetch(`${e}`, r)).pipe(
      br(() => pe),
      D((t) => (t.status !== 200 ? Ur(() => new Error(t.statusText)) : Z(t)))
    );
  }
  function Sr(e, r) {
    return Lo(e, r).pipe(
  ...
  (() => {
      ...
      constructor(n) {
        super(),
          ...
          (this.m = (i) => {
            i.source === this.w &&
              (this.dispatchEvent(
                new MessageEvent("message", { data: i.data })
              ),
        ...
        (o.hidden = !0),
          ...
          this.w.document.write(
            `<html><body><script>postMessage=${e};importScripts=${r};addEventListener("error",ev=>{parent.dispatchEvent(new ErrorEvent("error",{filename:"${n}",error:ev.error}))})<\/script><script src=${n}?${+Date.now()}><\/script></body></html>`
          ),
    ...
    (window.IFrameWorker = t),
      location.protocol === "file:" && (window.Worker = t);
  })();
  ...
  function fn(e) {
    let r = Nt(e),
      t = N(K(e, "keyup"), K(e, "focus").pipe(Dr(1))).pipe(
        k(() => e.value),
        he(e.value),
        le()
      );
  ...
  function gn(e, r, t) {
    return re(
      ...
      re("span", { class: "twemoji" }, re("img", { src: e.url })),
      re(
        "button",
        {
            ...
            r.pipe(
              k(({ icons: o, emojis: i }) => ({
                data: n.map((a) => {
                  ...
                  return { shortcode: a, url: [c.base, c.data[a]].join("") };
                }),
              }))
            )
          )
  ...
  function Sn(e, { index$: r, query$: t }) {
    let n = new B(),
      o = tn(e).pipe(we(Boolean)),
      i = ee(":scope > :first-child", e);
    n.pipe(Fe(t)).subscribe(([{ data: u }, { value: s }]) => {
      if (s)
        switch (u.length) {
          case 0:
    ...
    return (
      n
        ...
        .subscribe(([u, { value: s }]) => c.appendChild(gn(u, s, a))),
      Po(e, { query$: t, index$: r }).pipe(
        Pe((u) => n.next(u)),
        Ee(() => n.complete()),
        k((u) => Ke({ ref: e }, u))
      )
    ...
    return (
      r.subscribe((o) => {
        ...
        for (let a of o.sponsors)
          a.type === "public" && i.appendChild(wn(a.user));
        i.appendChild(
          En(o.sponsors.filter(({ type: a }) => a === "private").length)
        ),
  ...
  Tn();
  var Fo = document$.pipe(
    D(() =>
      N(
        ...Yr("iconsearch").map((e) => _n(e)),
        ...Yr("sponsorship").map((e) => On(e))
      )
    )
  );
  Fo.subscribe();
