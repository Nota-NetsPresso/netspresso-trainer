...
from datasets.parsers.parser_image_folder import ParserImageFolder
from datasets.parsers.parser_image_tar import ParserImageTar
from datasets.parsers.parser_image_in_tar import ParserImageInTar
