...
def create_segmentation_dataset(args, split, transform, target_transform=None):
    data_format = args.data.format
    if data_format == 'local':
        return SegmentationCustomDataset(args, split=split,
                                         transform=transform, target_transform=target_transform)
    elif data_format == 'huggingface':
        return SegmentationHFDataset(args, split=split,
                                     transform=transform, target_transform=target_transform)
    else:
